## ✨ Popular linux distributions configured with systemd, ttyd and sshd (ubuntu_20.04) ✨
...
The image relating to this Dockerfile is available for both amd64 and arm64 on Docker Hub - ```spurin/container-systemd-sshd-ttyd:ubuntu_20.04```
...
```
CONTAINER=$(docker run -p 7681:7681 -p 2222:22 -d --privileged spurin/container-systemd-sshd-ttyd:ubuntu_20.04)
